...
ACCESS_STAGE_INDEX_BUFFER: Access_Stage : {access = {.Index_Buffer}, stages = {}}
ACCESS_STAGE_ARGUMENT_BUFFER: Access_Stage : {access = {.Argument_Buffer}, stages = {.Indirect}}
...
ACCESS_LAYOUT_STAGE_PRESENT: Access_Layout_Stage : {access = {}, layout = .Present}
